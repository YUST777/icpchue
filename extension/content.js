/**
 * Verdict Helper Extension v1.3.1 — Content Script
 *
 ...
 *
 * v1.3.1: the extension reads the user's submissions itself (from their own
...
(() => {
    ...
    marker.setAttribute('data-version', '1.3.1');
