...
function DashboardSessionContent() {
    ...
    // Find by slug first, then fallback to number (for backward compatibility during transition if needed)
    ...
    }, [loading, isAuthenticated, router, campSlug, sessionSlug, session]);
